...
public class MonaCompoundImageServlet extends HttpServlet
{
    ...
    public void init(ServletConfig config) throws ServletException
    {
        ...
        query = "select s.structure from mona.compound_structures s, mona.compound_bases b where b.id = s.compound and b.accession = ?";
    ...
    private IAtomContainer getMolecule(String id) throws SQLException, CDKException, IOException
    {
