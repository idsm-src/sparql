...
@header { package cz.iocb.chemweb.server.sparql.grammar; }
...
TABLE_OPTION : ('T'|'t')('A'|'a')('B'|'b')('L'|'l')('E'|'e')'_'('O'|'o')('P'|'p')('T'|'t')('I'|'i')('O'|'o')('N'|'n');  
...
// this is used to match invalid merging of tokens, e.g. SELECTDISTINCT or LIMIT100
// otherwise, the lexer would incorrectly manage to process them
INVALID : [a-zA-Z0-9]+;
