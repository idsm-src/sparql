...
public class PubChemConfiguration extends SparqlDatabaseConfiguration
{
    ...
    public PubChemConfiguration() throws FileNotFoundException, IOException, SQLException
    {
        ...
        properties.load(new FileInputStream(Utils.getConfigDirectory() + "/datasource-pubchem.properties"));
    ...
    {
        addIriClass(new IriClass("pubchem", Arrays.asList("integer"),
                "http://rdf.ncbi.nlm.nih.gov/pubchem/compound/CID[0-9]+"));
    }
    ...
    private void loadProcedures()
    {
        ...
        IriClass pubchem = getIriClass("pubchem");
        ...
        subsearch.addParameter(new ParameterDefinition(sachem + "tautomers", LiteralClass.xsdBoolean,
                new Literal("false", new IRI(Xsd.BOOLEAN))));
        subsearch.addResult(new ResultDefinition(pubchem));
        ...
        simsearch.addParameter(new ParameterDefinition(sachem + "topn", LiteralClass.xsdInteger,
                new Literal("-1", new IRI(Xsd.INTEGER))));
        simsearch.addResult(new ResultDefinition(sachem + "compound", pubchem, "compound"));
        ...
        simcmpsearch.addParameter(new ParameterDefinition(sachem + "topn", LiteralClass.xsdInteger,
                new Literal("-1", new IRI(Xsd.INTEGER))));
        simcmpsearch.addResult(new ResultDefinition(null, pubchem, "compound"));
