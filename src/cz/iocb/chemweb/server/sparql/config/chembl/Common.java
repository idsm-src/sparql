...
class Common
{
    ...
    {
        config.addIriClass(new UserIriClass(schema, "efo", Arrays.asList("varchar"),
        ...
        config.addIriClass(new UserIriClass(schema, "bao", Arrays.asList("varchar"),
                "http://www\\.bioassayontology\\.org/bao#BAO_[0-9]{7}"));

        config.addIriClass(new UserIriClass(schema, "taxonomy", Arrays.asList("bigint"),
                "http://identifiers\\.org/taxonomy/[1-9][0-9]*"));

        config.addIriClass(new UserIriClass(schema, "ncbi_taxonomy", Arrays.asList("bigint"),
