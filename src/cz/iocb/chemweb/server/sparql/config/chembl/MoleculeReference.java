...
class MoleculeReference
{
    ...
    {
        config.addIriClass(new UserIriClass("pubchem_compound_reference", Arrays.asList("varchar"),
                "http://pubchem\\.ncbi\\.nlm\\.nih\\.gov/compound/[1-9][0-9]*"));
        config.addIriClass(new UserIriClass("pubchem_substance_reference", Arrays.asList("varchar"),
                "http://pubchem\\.ncbi\\.nlm\\.nih\\.gov/substance/[1-9][0-9]*"));
        config.addIriClass(new UserIriClass("zinc_reference", Arrays.asList("varchar"),
                "http://zinc15\\.docking\\.org/substances/ZINC[0-9]{12}"));
        config.addIriClass(new UserIriClass("sure_chembl_reference", Arrays.asList("varchar"),
                "https://www\\.surechembl\\.org/chemical/SCHEMBL[0-9]+"));
        config.addIriClass(new UserIriClass("molport_reference", Arrays.asList("varchar"),
                "https://www\\.molport\\.com/shop/molecule-link/MolPort(-[0-9]{3}){3}"));
        config.addIriClass(new UserIriClass("emolecules_reference", Arrays.asList("varchar"),
                "https://www\\.emolecules\\.com/cgi-bin/more\\?vid=[1-9][0-9]*"));
        config.addIriClass(
                new UserIriClass("mcule_reference", Arrays.asList("varchar"), "https://mcule\\.com/MCULE-[1-9][0-9]*"));
        config.addIriClass(new UserIriClass("ibm_patent_structure_reference", Arrays.asList("varchar"),
                "http://www-935\\.ibm\\.com/services/us/gbs/bao/siip/nih/\\?sid=[A-F0-9]+"));
        config.addIriClass(new UserIriClass("nikkaji_reference", Arrays.asList("varchar"),
                "http://jglobal\\.jst\\.go\\.jp/en/redirect\\?Nikkaji_No=[A-Z0-9.]+"));
        config.addIriClass(new UserIriClass("actor_reference", Arrays.asList("varchar"),
                "http://actor\\.epa\\.gov/actor/chemical\\.xhtml\\?casrn=[1-9][0-9]*-[0-9]{2}-[0-9]"));
        config.addIriClass(new UserIriClass("chebi_reference", Arrays.asList("varchar"),
                "http://www\\.ebi\\.ac\\.uk/chebi/searchId\\.do\\?chebiId=CHEBI%3A[1-9][0-9]*"));
        config.addIriClass(new UserIriClass("pdbe_reference", Arrays.asList("varchar"),
                "http://www\\.ebi\\.ac\\.uk/pdbe-srv/pdbechem/chemicalCompound/show/[A-Z0-9]{1,3}"));
        config.addIriClass(new UserIriClass("nmr_shift_db2_reference", Arrays.asList("varchar"),
                "http://nmrshiftdb\\.org/molecule/[1-9][0-9]*"));
        config.addIriClass(new UserIriClass("kegg_ligand_reference", Arrays.asList("varchar"),
                "http://www\\.genome\\.jp/dbget-bin/www_bget\\?C[0-9]{5}"));
        config.addIriClass(new UserIriClass("drugbank_reference", Arrays.asList("varchar"),
                "http://www\\.drugbank\\.ca/drugs/DB[0-9]{5}"));
        config.addIriClass(new UserIriClass("hmdb_reference", Arrays.asList("varchar"),
                "http://www\\.hmdb\\.ca/metabolites/HMDB[0-9]{7}"));
        config.addIriClass(new UserIriClass("iuphar_reference", Arrays.asList("varchar"),
                "http://www\\.guidetopharmacology\\.org/GRAC/LigandDisplayForward\\?ligandId=[1-9][0-9]*"));
        config.addIriClass(new UserIriClass("selleck_reference", Arrays.asList("varchar"),
                "http://www\\.selleckchem\\.com/products/[^/]*\\.html"));
        config.addIriClass(new UserIriClass("pharm_gkb_reference", Arrays.asList("varchar"),
                "http://www\\.pharmgkb\\.org/drug/PA[1-9][0-9]*"));
        config.addIriClass(new UserIriClass("atlas_reference", Arrays.asList("varchar"),
                "http://www\\.ebi\\.ac\\.uk/gxa/query\\?conditionQuery=.+"));
        config.addIriClass(new UserIriClass("recon_reference", Arrays.asList("varchar"),
                "http://vmh\\.uni\\.lu/#metabolite/[^/]+"));
        config.addIriClass(new UserIriClass("wikipedia_mol_reference", Arrays.asList("varchar"),
                "http://en\\.wikipedia\\.org/wiki/.+"));
        config.addIriClass(new UserIriClass("lincs_reference", Arrays.asList("varchar"),
                "http://identifiers\\.org/lincs\\.smallmolecule/LSM-[1-9][0-9]*"));
        config.addIriClass(new UserIriClass("fda_srs_reference", Arrays.asList("varchar"),
    ...
    static void addQuadMapping(ChemblConfiguration config)
    {
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("pubchem_compound_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' PubChem Reference: ' || reference)"),
                "reference_type = 'PUBCHEM'");

        config.addQuadMapping("molecule_reference_types", graph,
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("pubchem_substance_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("zinc_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' Zinc Reference: ' || reference)"),
                "reference_type = 'ZINC'");

        config.addQuadMapping("molecule_reference_types", graph, config.createIriMapping("zinc_reference", "reference"),
                config.createIriMapping("rdf:type"), config.createIriMapping("cco:ZincRef"), "reference_type = 'ZINC'");


        config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                config.createIriMapping("sure_chembl_reference", "reference"), "reference_type = 'SURE CHEMBL'");

        config.addQuadMapping(table, graph, config.createIriMapping("sure_chembl_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' SureChEMBL Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("molport_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' MolPort Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("emolecules_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' eMolecules Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("mcule_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' Mcule Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("ibm_patent_structure_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("nikkaji_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' Nikkaji Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("actor_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("chebi_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' ChEBI Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("pdbe_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' PDBe Reference: ' || reference)"),
                "reference_type = 'PDBE'");

        config.addQuadMapping("molecule_reference_types", graph, config.createIriMapping("pdbe_reference", "reference"),
                config.createIriMapping("rdf:type"), config.createIriMapping("cco:PdbeRef"), "reference_type = 'PDBE'");


        config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                config.createIriMapping("nmr_shift_db2_reference", "reference"), "reference_type = 'NMR SHIFT DB2'");

        config.addQuadMapping(table, graph, config.createIriMapping("nmr_shift_db2_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' NMRShiftDB Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("kegg_ligand_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' Kegg Ligand Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("drugbank_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' DrugBank Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("hmdb_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
        ...
        config.addQuadMapping("molecule_reference_types", graph, config.createIriMapping("hmdb_reference", "reference"),
                config.createIriMapping("rdf:type"), config.createIriMapping("cco:HmdbRef"), "reference_type = 'HMDB'");


        config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                config.createIriMapping("iuphar_reference", "reference"), "reference_type = 'IUPHAR'");

        config.addQuadMapping(table, graph, config.createIriMapping("iuphar_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' IUPHAR Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("selleck_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("pharm_gkb_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' PharmGKB Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("atlas_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("recon_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' Recon Reference: ' || reference)"),
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("wikipedia_mol_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("lincs_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
        ...
        config.addQuadMapping(table, graph, config.createIriMapping("fda_srs_reference", "reference"),
                config.createIriMapping("rdfs:label"),
                config.createLiteralMapping(xsdString,
                        "((select chembl_id from molecule_dictionary where molregno = molecule_references.molregno) || "
                                + "' FDA/USP SRS Reference: ' || reference)"),
