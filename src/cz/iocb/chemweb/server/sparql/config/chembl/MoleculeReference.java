    ...
    public static void addQuadMappings(SparqlDatabaseConfiguration config)
    {
...

        {
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'ZINC'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'SURE CHEMBL'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'MOLPORT'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'EMOLECULES'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'MCULE'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    config.createIriMapping("reference:ibm_patent_structure", "reference"), config.createAreEqualCondition(
                            "reference_type", "'IBM PATENT STRUCTURE'::chembl.molecule_reference_type"));
            config.addQuadMapping(table, graph, config.createIriMapping("reference:ibm_patent_structure", "reference"),
                    ...
                    config.createAreEqualCondition("reference_type",
                            "'IBM PATENT STRUCTURE'::chembl.molecule_reference_type"));

            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    config.createIriMapping("reference:nikkaji", "reference"),
                    config.createAreEqualCondition("reference_type", "'NIKKAJI'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'ACTOR'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'PDBE'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'NMR SHIFT DB2'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'KEGG LIGAND'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'DRUGBANK'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'HMDB'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'IUPHAR'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'SELLECK'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'PHARM GKB'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'ATLAS'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'RECON'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'WIKIPEDIA MOL'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'LINCS'::chembl.molecule_reference_type"));
            ...
            config.addQuadMapping(table, graph, subject, config.createIriMapping("cco:moleculeXref"),
                    ...
                    config.createAreEqualCondition("reference_type", "'FDA SRS'::chembl.molecule_reference_type"));
