...
class Compound
{
    ...
    static void addQuadMapping(PubChemConfiguration config)
    {
...

        {
            ...
            config.addQuadMapping("pubchem", table, graph, subject, config.createIriMapping("sio:CHEMINF_000480"),
...

        {
            ...
            config.addQuadMapping("pubchem", table, graph, subject, config.createIriMapping("sio:CHEMINF_000455"),
...

        {
            ...
            config.addQuadMapping("pubchem", table, graph, subject, config.createIriMapping("vocab:has_parent"),
...

        {
            ...
            config.addQuadMapping("pubchem", table, graph, subject, config.createIriMapping("sio:CHEMINF_000461"),
...

        {
            ...
            config.addQuadMapping("pubchem", table, graph, subject, config.createIriMapping("sio:CHEMINF_000462"),
                    config.createIriMapping(compound, "isomer"));
        }

        {
            ...
            config.addQuadMapping("pubchem", table, graph, subject, config.createIriMapping("obo:has-role"), config
