...
public class DateCompositeClassTest extends AbstractResourceClassTest
{
    protected DateCompositeClassTest()
    {
        String noZone = Integer.toString(Integer.MIN_VALUE);

        super(new DateCompositeClass(), List.of("date", "int4"), Map.ofEntries(
        // @formatter:off
            // canonical
