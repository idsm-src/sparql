...
public class DateTimeCompositeClassTest extends AbstractResourceClassTest
{
    protected DateTimeCompositeClassTest()
    {
        String noZone = Integer.toString(Integer.MIN_VALUE);

        super(new DateTimeCompositeClass(), List.of("timestamptz", "int4"), Map.ofEntries(
        // @formatter:off
            // canonical
