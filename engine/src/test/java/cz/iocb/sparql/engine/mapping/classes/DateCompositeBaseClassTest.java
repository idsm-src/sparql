...
public class DateCompositeBaseClassTest extends AbstractResourceClassTest
{
    protected DateCompositeBaseClassTest()
    {
        String noZone = Integer.toString(Integer.MIN_VALUE);

        super(new DateCompositeBaseClass(), List.of("date", "int4", "varchar"), Map.ofEntries(
        // @formatter:off
            // canonical
