...
public class DateScalarBaseClassTest extends AbstractResourceClassTest
{
    protected DateScalarBaseClassTest()
    {
        super(new DateScalarBaseClass(), List.of("sparql.zoneddate", "varchar"), Map.ofEntries(
        // @formatter:off
            // canonical
            ...
            // non-canonical
            entry("1970-01-01+00:00", List.of("1970-01-01Z", "1970-01-01+00:00")),
            entry("1970-01-01-00:00", List.of("1970-01-01Z", "1970-01-01-00:00")),
            entry(" 1970-01-01Z", List.of("1970-01-01Z", " 1970-01-01Z")),
            entry("1970-01-01Z ", List.of("1970-01-01Z", "1970-01-01Z ")),
            entry(" 1970-01-01Z ", List.of("1970-01-01Z", " 1970-01-01Z ")) ,
